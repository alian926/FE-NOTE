...
/**
 * 来自jQuery实现
 * 该对象是通过 "{}" 或 "new Object" 创建的
 * 其他的 JavaScript对象如 null，数组，宿主对象（documents）等作区分
 */
...
/**
 * @description 合并两个或者更多的对象的内容到第一个对象中
 * jQuery.extend( [deep], target, object1 [, objectN ] )
 */
function extend() {
	// 默认不进行深拷贝
	let deep = false;
  // name: 键名 options 待复制对象, src 结果属性值, clone 计算后的复制值, copyIsArray 拷贝对象是否为数组
